...
public class NestContainerGui extends GuiContainer {
    public static final int WIDTH = 180;
    public static final int HEIGHT = 137;
    
    public NestTE tileEntity;
    public NestContainer container;

    private static final ResourceLocation background = new ResourceLocation(Main.MOD_ID, "textures/gui/trough.png");

    public NestContainerGui(NestTE tileEntity, NestContainer container) {
        super(container);
